...
export async function ensureSchema() {
  await pool.query(`
    ...
    ALTER TABLE external_fb_posts ADD COLUMN IF NOT EXISTS last_error TEXT;
    ...
    ALTER TABLE sites ADD COLUMN IF NOT EXISTS details_line BOOLEAN NOT NULL DEFAULT FALSE;
  `);
}
